---
title: "[WebRTC 박살내기 #3] PeerConnection API와 이벤트 흐름"
description: "WebRTC 박살내기 세번째 시리즈 입니다. WebRTC의 핵심 RTCPeerConnection을 완벽하게 이해하고, 연결 생성부터 이벤트 처리, 품질 관리, 연결 복구까지 실전 예제와 함께 알아봅니다."
...
안녕하세요! 지난 글에서는 **MediaStream과 MediaStreamTrack**을 살펴보았습니다.
...
>
> ICE와 STUN/TURN에 대한 자세한 설명은 [이전 글](https://www.chan9yu.dev/posts/webrtc-deepdive-01#ICE%EA%B0%80-%ED%95%B4%EA%B2%B0%ED%95%A9%EB%8B%88%EB%8B%A4)을 확인해주세요.
...
![WebRTC TURN Server](https://raw.githubusercontent.com/chan9yu/blog9yu-content/refs/heads/main/posts/webrtc-deepdive-03/images/image-01.png)
...
![이벤트 발생 흐름](https://raw.githubusercontent.com/chan9yu/blog9yu-content/refs/heads/main/posts/webrtc-deepdive-03/images/image-02.png)
...
![Offer / Answer 교환 순서](https://raw.githubusercontent.com/chan9yu/blog9yu-content/refs/heads/main/posts/webrtc-deepdive-03/images/image-03.png)
...
- 이벤트 리스너 먼저 등록
- `negotiationneeded`는 자동 발생
- 패킷 손실률 5% 이상이면 품질 조절
- 연결 끊기면 ICE Restart로 복구
- 종료 시 반드시 리소스 정리

다음 글에서는 실시간 채팅 / 파일 전송 / 게임 데이터 동기화 등
영상/음성이 아닌 일반 데이터를 P2P로 주고받는 **RTCDataChannel**에 대해 알아보겠습니다.
