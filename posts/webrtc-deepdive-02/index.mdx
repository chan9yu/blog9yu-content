---
title: "[WebRTC 박살내기 #2] 미디어 스트림과 트랙 완벽 이해"
...
**[Media Capture and Streams API](https://developer.mozilla.org/ko/docs/Web/API/Media_Capture_and_Streams_API)**(줄여서 MediaStream API)는 WebRTC와 함께 사용되는 핵심 API 입니다.
